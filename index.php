...
<div class="gre">
    <img style="width: 130px; height: 100px; left: 780px; top: 25px;  border-radius: 13px" src="asset/img/blocks(2).png">
...
<div class="grey">
<img style="width: 130px; height: 100px; left: 970px; top: 25px;  border-radius: 13px" src="asset/img/blocks(4).png" />
...
<div class="grey">
<img style="width: 130px; height: 100px; left: 590px; top: 25px;  border-radius: 13px" src="asset/img/blocks(3).png" />
...
<div class="grey">
<img style="width: 130px; height: 100px; left: 400px; top: 25px; border-radius: 13px" src="asset/img/blocks(1).png" />
...
<div class="row1__character">
    ...
    <div class="cart__character">
        <div class="line__end"></div>
        <div class="block__cart-text">
            <div class="zag__cart-text"><div class="ph__n"><img src="asset/img/h1.png" alt=""></div>
                Экологичный
            </div>
            <div class="cart-text__opis">Благодаря своему составу
                (древесная щепа, портландцемент и
                добавка, используемая также при промышленной
                очистке воды) арболит считается самым
                безопасным строительным материалом для здоровья
                человека.</div>
        </div>
    </div>
    <div class="cart__character-one">
        <div class="line__end"></div>
        <div class="block__cart-text">
            <div class="zag__cart-text"><div class="ph__n"><img src="asset/img/h2.png" alt=""></div>
                Огнестойкий
            </div>


            <div class="cart-text__opis">Арболит относится к классу
                трудновоспламеняемых материалов,
                этот материал способен противодействовать
                открытому огню более 1,5ч.</div>
        </div>
    </div>
    <div class="cart__character-two">
        <div class="line__end"></div>
        <div class="block__cart-text">
            <div class="zag__cart-text"><div class="ph__n"><img src="asset/img/h3.png" alt=""></div>
                Теплый
            </div>


            <div class="cart-text__opis">Арболит морозостойкий и при этом отлично
                сохраняет тепло. Показатель теплопроводности 30 сантиметровой
                стены из арболита соответствует показателю теплопроводности
                метровой стены из обычного кирпича.</div>
        </div>
    </div>
    <div class="cart__character">
        <div class="line__end"></div>
        <div class="block__cart-text">
            <div class="zag__cart-text"><div class="ph__n"><img src="asset/img/h4.png" alt=""></div>
                Легкий
            </div>


            <div class="cart-text__opis">Арболит удобен в работе, так как блоки имеют
                больший размер и меньший вес. Легкость арболита позволяет заложить любой
                тип мелкозаглубленного
                фундамента, так же удобно при транспортировке и доставке к месту проведения строительных
                работ.
            </div>
        </div>
    </div>
...
<div class="row1__character">
    ...
    <div class="cart__character">
        <div class="line__end"></div>
        <div class="block__cart-text">
            <div class="zag__cart-text"><div class="ph__n"><img src="asset/img/h5.png" alt=""></div>
                Звукоизолирую- <br> щий
            </div>


            <div class="cart-text__opis">Дом из арболита имеет высокие показатели шумоизоляции,
                благодаря пористой структуре звук гасится внутри арболитовых блоков</div>
        </div>
    </div>
    <div class="cart__character-one">
        <div class="line__end"></div>
        <div class="block__cart-text">
            <div class="zag__cart-text"><div class="ph__n"><img src="asset/img/h6.png" alt=""></div>
                Прочный
            </div>


            <div class="cart-text__opis">Имеет высокий предел прочности при изгибе благодаря волокнистой
                структуре древесного наполнителя.</div>
        </div>
    </div>
    <div class="cart__character-two">
        <div class="line__end"></div>
        <div class="block__cart-text">
            <div class="zag__cart-text"><div class="ph__n"><img src="asset/img/h7.png" alt=""></div>
                Геометрически точный
            </div>


            <div class="cart-text__opis">Используя высокотехнологичное оборудование, мы выдерживаем
                арболит в специальных формах для обеспечения точной геометрии блоков.</div>
        </div>
    </div>
    <div class="cart__character">
        <div class="line__end"></div>
        <div class="block__cart-text">
            <div class="zag__cart-text"><div class="ph__n"><img src="asset/img/h8.png" alt=""></div>
                Долговечный
            </div>


            <div class="cart-text__opis">Благодаря своему натуральному составу арболит не подвержен
                гниению и образованию грибка и плесени. <br><br><br><br><br><br><br><br></div>
        </div>
    </div>
